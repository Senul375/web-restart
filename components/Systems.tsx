      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
          {systems.cards.map((card) => (
            <div
              key={card.title}
              className="overflow-hidden rounded-[16px] bg-[linear-gradient(to_right,#4F46E5,#7C3AED)] pt-[3px] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_0_32px_rgba(79,70,229,0.15)]"
            >
              <div className="rounded-b-[14px] bg-[#111116] px-8 pb-8 pt-8">
